...
Algorithmically, when a snake moves on the board, we need to
update the arraylist.  The easiest way to update is to do 2 things:
...
**B1:** There are four different directions --- you can call them up/down/
...
**B2:** Next, write the constructor for Snake, which takes a Location
...
**B3:** Next, fill in the toString() method for Snake.  This method should
...
**B4: STOP AND TEST**.  Go to Tests.java and run the testToString method.
Do not go on until the println statements print the two snakes' 
directions and bodies with their segments.

**B5:** Next, write getHeadLocation() and getBody().  Read the java comments
to see what these functions do.

**B6:** Next, write changeDirection().  This function will be called whenever
...
**B7:** Next, write the grow() method.  This method should examine the
...
**B8: STOP AND TEST**.  Go to Tests.java and write a testGrow method.  Inside
...
**B9:** Next, write the move() method.  This method is just like grow(),
...
**B10: STOP AND TEST**.  Go to Tests.java and write a testMove method.  Inside
...
**C1:** First, fill in the part of draw() to draw the snake.  There's a
...
**C2: STOP AND TEST**.  When you think you've got it, run the game and you
...
**C3: STOP AND TEST**.  Now run the game and you should see a 1-segment snake 
on the board.  When you click to start the game, it should start 
moving on the board!

**C4:** Next, let's make the key presses change the snake's direction. In
...
**C5: STOP AND TEST**.  When you think you've got it, run the game and you
should be able to control the snake with the keyboard.

**C6:** Next, let's make the snake detect when it eats an apple.  Fill
...
**C7:** STOP AND TEST.  When you think you've got it, run the game and you
should be able to have the snake eat the apples, and it should grow
appropriately.

**C8:** Next, let's make the snake detect collisions with the walls of
...
**C9:** Next, add a second snake to the game.  You will need to add a second
...
Bonus enhancements (This is optional/just for fun!): 
